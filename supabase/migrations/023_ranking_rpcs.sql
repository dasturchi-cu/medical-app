-- Reyting RPC: kunlik (00:00 Toshkent) va umumiy (barcha kunlar yig‘indisi).
...
-- Umumiy: har bir kunning ko‘rilgan vaqti yig‘indisi (rank_daily_lesson_watch).
...
grant execute on function public.get_daily_ranking(int, uuid) to anon, authenticated, service_role;
